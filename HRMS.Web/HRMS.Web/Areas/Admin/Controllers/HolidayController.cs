...
namespace HRMS.Web.Areas.Admin.Controllers
{
    ...
    public class HolidayController : Controller
    {
        ...
        public JsonResult HolidayListings(string sEcho, int iDisplayStart, int iDisplayLength, string sSearch)
        {
            ...
            var data = _businessLayer.SendPostAPIRequest(HolidayParams, _businessLayer.GetFormattedAPIUrl(APIControllarsConstants.Holiday, APIApiActionConstants.GetAllHoliday), HttpContext.Session.GetString(Constants.SessionBearerToken), true).Result.ToString();
        ...
        public IActionResult Index(string id)
        {
            ...
            if (!string.IsNullOrEmpty(id))
            {
                ...
                var data = _businessLayer.SendPostAPIRequest(HolidayModel, _businessLayer.GetFormattedAPIUrl(APIControllarsConstants.Holiday, APIApiActionConstants.GetAllHoliday), HttpContext.Session.GetString(Constants.SessionBearerToken), true).Result.ToString();
