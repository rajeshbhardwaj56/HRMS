                ...
                attendanceList = dataSet.Tables[0].AsEnumerable()
                    .Select(dataRow =>
                    {
                        var attendance = new AttendanceViewModel
                        {
                            ...
                            ECO = Convert.ToDecimal(dataRow["ECO"]),
                            HECO = Convert.ToDecimal(dataRow["HECO"]),
...
new SqlParameter("@DisplayLength", model.DisplayLength),
            ...
            List<SqlParameter> sqlParameters = new()
    {
        ...
        {
            LeaveEligibilityResult result = new LeaveEligibilityResult();
            ...
            List<SqlParameter> sqlParameters = new List<SqlParameter>
        {
            ...
            var dataSet = DataLayer.GetDataSetByStoredProcedure(
                StoredProcedures.usp_CheckLeaveEligibility,
                sqlParameters
            );
            ...
            if (dataSet.Tables.Count > 0 && dataSet.Tables[0].Rows.Count > 0)
            {
                ...
                result.IsEligible = Convert.ToBoolean(row["IsEligible"]);
